<?php /* C:\wamp64\www\CDW1\resources\views/home.blade.php */ ?>
...
<section>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form role="form" action="<?php echo e(route('postHome')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <input name="flight_time_from" type="date" class="form-control" required="true" value="<?php echo e(@Session::get('flight_time_from')); ?>">
                        </div>
                        <div class="form-group">
                            <div class="radio">
                        ...
                        <div class="form-group" id="flight_time_to">
                            ...
                            <input name="flight_time_to" type="date" class="form-control" value="<?php echo e(@Session::get('flight_time_to')); ?>">
                        </div>
                    </div>
                    <script>
                        $(document).ready(function () {
