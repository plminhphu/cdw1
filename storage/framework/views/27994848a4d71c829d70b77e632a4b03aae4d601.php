<?php /* C:\wamp64\www\CDW1\resources\views/flightdetail.blade.php */ ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 text-right">
                                ...
                                <div>
                                    <a href="<?php echo e(url('/flight-checked-'.@$flightlist->id_flightlist)); ?>" class="btn btn-primary">Choose</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                                ...
                                <ul class="list-group">
                                    <?php for ($i = 0; $i < count($transit); $i++): ?>
                                        <li class="list-group-item">
                                            <h5>
                                                <strong class="airline"><?php echo e(@$airlines->name_airline); ?></strong>
                                                <p><span class="flight-class"><?php echo e(@$flightclass->name_flightclass); ?></span></p>
                                            </h5>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="row">
                            ...
                            <div id="flight-price-tab" class="tab-pane fade">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <div class="pull-left">
                                            <strong>Passengers Fare (x<?php echo e(@Session::get('flight_number')); ?>)</strong>
                                        </div>
